...
//      /// \todo use boost outcome for error reporting
//      LOG(ERROR) <<  "ERROR while running code\n" << code.substr(0, 100);
//      std::terminate();
//    }
//}
//
...
//    } else {
//        /// \todo use boost outcome for error reporting
//        LOG(WARNING) << "module not found!" << module_id.c_str();
//        for(const auto& it : InterpreterModule::interpMap) {
//            LOG(WARNING) << "maybe you wanted to type " << it.first.c_str();
//        }
//    }
//}
//
...
//      args.push_back(it);
//      /// \todo use boost outcome for error reporting
//      DLOG(INFO) << "InterpreterModule::extra_args = " << it;
//    }
//}
//
...
//          /// \todo use boost outcome for error reporting
//          DLOG(INFO) << "added to InterpreterModule file " << full_path.string();
//        }
//      }
//    }
//
...
//        /// \todo use boost outcome for error reporting
//        DLOG(INFO) << "reloaded module " << it.first;
//    }
//#else
...
//
//    /// \todo use boost outcome for error reporting
//    DLOG(INFO) << "LLVMDIR is " << LLVMDIR;
//
//    fs::path abs_cur_path = fs::absolute(fs::current_path());
//
//    DLOG(INFO) << "fs::current_path() is " << abs_cur_path.string();
//
...
//      LOG(WARNING) << "can`t find ctp_scripts folder in ctp_search_paths";
//    }
...
//        /// \todo use boost outcome for error reporting
//        DLOG(INFO) << "dispatched reloadAllCling event!... ";
//        reloadAllCling();
//        {
