...
struct TemplateType
{
  ...
  {
    const TypeInfoPtr* result
      = std::get_if<TypeInfoPtr>(&arguments[idx]);
    return result
      ? *result
      : TypeInfoPtr();
  }
...
public:
  ...
  static TypeInfoPtr Create(
    const clang::QualType& qt, const clang::ASTContext* astContext);
...
inline std::ostream& operator << (
  std::ostream& os, const NoType& tp)
{
  os << "NOTYPE";
  return os;
}
...
inline std::ostream& operator << (
  std::ostream& os, const BuiltinType& tp)
{
...
inline std::ostream& operator << (
  std::ostream& os, const RecordType& tp)
{
...
inline std::ostream& operator << (
  std::ostream& os, const TemplateType::GenericArg& ga)
{
  os << "GENERIC(" << ga.kind << ")";
  return os;
}
...
inline std::ostream& operator << (
  std::ostream& os, const WellKnownType& tp)
{
...
*/
inline std::ostream& operator << (
  std::ostream& os, const EnumType& tp)
{
...
inline std::ostream& operator << (
  std::ostream& os, const DecltypeType& tp)
{
  os << "DECLTYPE[]";
  return os;
}
...
inline std::ostream& operator << (
  std::ostream& os, const TemplateParamType& tp)
{
